...
if __name__ == "__main__":
    ...
    sstrainset, imsize, _ = load_data(args.data, args.data_root, args.data_episode_folder_pattern, args.data_cache,
                                      args.data_imsize,False, image_file_extension=args.image_file_extension)
    val_dataset, *_ = load_data(args.data, args.data_root, args.data_episode_folder_pattern, args.data_cache,
                                args.data_imsize,True, image_file_extension=args.image_file_extension)
